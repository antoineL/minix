...
CPPFLAGS+= -I ${.CURDIR}/..  -I ${.CURDIR}/../../lib -I ${.CURDIR}/../../lib/libsa
CPPFLAGS+= -I ${.OBJDIR}
...
#CPPFLAGS+= -I$S
CPPFLAGS+= -I${.CURDIR}/../.. -I${.CURDIR}/../../nbsdsys_include
...
.else
.include "${.CURDIR}/../../lib/libsa/Makefile.inc"
.endif
LIBSA= ${SALIB}
...
.else
.include "${.CURDIR}/../../lib/libz/Makefile.inc"
.endif
LIBZ= ${ZLIB}
...
.else
	${HOST_SH} ${.CURDIR}/../../nbsd_tools/conf/newvers_stand.sh \
				${VERSIONFILE} x86 ${NEWVERSWHAT}
.endif
